...
InModuleScope $script:subModuleName {
    Describe 'WSManDsc.Common\Test-DscParameterState' -Tag TestDscParameterState {
    ...
    Describe 'WSManDsc.Common\Get-LocalizedData' {
        $mockTestPath = {
    ...
    Describe 'WSManDsc.Common\New-InvalidResultException' {
    ...
    Describe 'WSManDsc.Common\New-ObjectNotFoundException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'WSManDsc.Common\New-InvalidOperationException' {
        Context 'When calling with Message parameter only' {
            It 'Should throw the correct error' {
                $mockErrorMessage = 'Mocked error'
    ...
    Describe 'WSManDsc.Common\New-NotImplementedException' {
    ...
    Describe 'WSManDsc.Common\New-InvalidArgumentException' {
    ...
    Describe 'WSManDsc.Common\Test-CertificatePath' {
    ...
    Describe 'WSManDsc.Common\Test-Thumbprint' {
    ...
    Describe 'WSManDsc.Common\Find-Certificate' {
    ...
    Describe 'WSManDsc.Common\Find-CertificateAuthority' {
    ...
    Describe 'WSManDsc.Common\Test-CertificateAuthority' {
        Mock `
...
"@
    ...
    Describe 'WSManDsc.Common\Get-CertificateTemplateName' {
...
'@
    ...
    Describe 'WSManDsc.Common\Get-CertificateTemplatesFromActiveDirectory' {
        $MockSearchResults = @(
            @{
                Properties = @(
                    @{
    ...
    Describe 'WSManDsc.Common\Get-CertificateTemplateInformation' {
        $mockADTemplates = @(
            @{
                'Name'                    = 'DisplayName1'
...
'@
    ...
    Describe 'WSManDsc.Common\Get-CertificateExtension' {
    ...
    Describe 'WSManDsc.Common\Get-CertificateTemplateExtensionText' {
...
'@
    ...
    Describe 'WSManDsc.Common\Get-CertificateSubjectAlternativeName' {
    ...
    Describe 'WSManDsc.Common\Get-CertificateSubjectAlternativeNameList' {
    ...
    Describe 'WSManDsc.Common\Test-CommandExists' {
    ...
    Describe 'WSManDsc.Common\Get-CertificateStorePath' {
    ...
    Describe 'WSManDsc.Common\Get-CertificatePath' {
    ...
    Describe 'WSManDsc.Common\Get-CertificateFromCertificateStore' {
    ...
    Describe 'WSManDsc.Common\Remove-CertificateFromCertificateStore' {
        Context 'When the certificate exists in the store' {
            Mock -CommandName Test-Path -MockWith { $true }
            Mock -CommandName Get-ChildItem -MockWith {
                @(
    ...
    Describe 'WSManDsc.Common\Set-CertificateFriendlyNameInCertificateStore' {
        Context 'When the certificate exists in the store' {
            Mock -CommandName Test-Path -MockWith { $true }
            Mock -CommandName Get-ChildItem -MockWith {
                @(
